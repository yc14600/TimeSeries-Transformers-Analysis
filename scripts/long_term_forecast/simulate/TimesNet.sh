...
python -u est_mi.py \
  ...
  --model_id independent_dp02_96_96 \
  --model $model_name \
  --data custom \
  --features M \
  --seq_len 96 \
...
python -u est_mi.py \
  ...
  --model_id independent_dp04_96_96 \
  --model $model_name \
  --data custom \
  --features M \
  --seq_len 96 \
...
python -u est_mi.py \
  ...
  --model_id independent_dp06_96_96 \
  --model $model_name \
  --data custom \
  --features M \
  --seq_len 96 \
...
python -u est_mi.py \
  ...
  --model_id independent_dp08_96_96 \
  --model $model_name \
  --data custom \
  --features M \
  --seq_len 96 \
...
python -u est_mi.py \
  ...
  --model_id independent_dp10_96_96 \
  --model $model_name \
  --data custom \
  --features M \
  --seq_len 96 \
