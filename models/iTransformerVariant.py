...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        if self.task_name == 'long_term_forecast' or self.task_name == 'short_term_forecast':
            ...
            # self.flat_proj = nn.Sequential(nn.Linear(configs.d_model * (4+configs.enc_in),configs.d_model * (4+configs.enc_in)),nn.ReLU())
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        # flat_enc_out = self.flat_proj(enc_out)
        # enc_out = flat_enc_out.view(s1,s2,s3)
