...
num_features = 2                    # Number of independent features
autocorr_coeff = 0.95                # Base autocorrelation coefficient
...
periodic_components_3 = {
    12: 0.02,      # Daily cycle (amplitude 1.0)
...
df[24:].to_csv(os.path.join(save_path,"independent_alpha"+str(int(autocorr_coeff*100))+".csv"), index=False)
